...
const Chat = () => {
    ...
    return (
        <div className="flex flex-col h-screen bg-gradient-to-b from-neutral-800 to-black">
            ...
            <main className="flex-1 p-2 overflow-y-auto container">
                {conversation?.length === 0 ? (
                    <div className="flex flex-col justify-center items-center h-full text-center font-serif">
                        ...
                        <h3 className="text-2xl pt-2 font-semibold text-neutral-300">
                    ...
                    conversation.map((chat, index) => (
                        <div className="space-y-2 mt-2" key={index}>
                            <div className="flex justify-end">
                                <div className="bg-blue-500 text-white py-2 px-4 rounded-t-lg rounded-l-lg max-w-md">
                                    {chat.user}
                                </div>
                            </div>
                            <div className="flex justify-start">
                                <div className="bg-gray-300 text-gray-900 py-2 px-4 rounded-t-lg rounded-r-lg max-w-screen-lg">
            ...
            <footer className="border-t border-gray-700 pb-5 pt-2 flex-none container px-2">
                    ...
                    />
                    {
                        loading ?
                            ...
                            <button
                                ...
                                className={`${!inputValue.trim() ? "bg-gray-400 cursor-not-allowed" :  "bg-gray-200"} hover:bg-gray-400 border-2 border-gray-900 text-black py-1 m-1 pl-3 pr-2 rounded-full`}
                            >
                                <IoMdSend size={30} />
                            </button>
                    }
